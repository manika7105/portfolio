    ...
    <section id="education" className="mx-auto max-w-5xl px-4 py-28">
      <Reveal>
        ...
        <p className="mt-3 text-sm text-[var(--muted)]">
          <i>The academic journey that laid the groundwork for my technical growth.</i>
        </p>
      </Reveal>
              ...
              <Reveal key={edu.institution + edu.degree} delay={i * 0.1}>
                <div className="relative pl-12 sm:pl-16">
                  ...
                  <TiltCard maxTilt={4} className="group block rounded-2xl">
                    <div className="card-surface flex flex-col justify-between gap-4 rounded-2xl p-6 transition-colors group-hover:border-[var(--accent-a)] sm:flex-row sm:items-center">
                      <div>
                        <p className="eyebrow">
